...
export class AdminSideMenuComponent {
  ...
  list = [
    ...
    {id:6,isSelected:false,link:'/admin/content-management',label:'إدارة المحتوى',selectedIcon:'assets/images/contentManagementLight.svg',unSelectedIcon:'assets/images/contentMAnagementDark.svg',subLink: []},
    {id:7,isSelected:false,link:'/admin/admin-management',label:'إدارة النظام',selectedIcon:'assets/images/systemManagementLight.svg',unSelectedIcon:'assets/images/systemManagementDark.svg',subLink: []},
